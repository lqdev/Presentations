...
namespace AutoMLML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\lqdev\Downloads\sentiment labelled sentences\sentiment labelled sentences\yelp_labelled.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SdcaLogisticRegression(new SdcaLogisticRegressionBinaryTrainer.Options() { L2Regularization = 0.001f, L1Regularization = 0.25f, ConvergenceTolerance = 0.001f, MaximumNumberOfIterations = 10, Shuffle = true, BiasLearningRate = 1f, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
